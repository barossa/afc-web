...
<html>
<head>
    <title><fmt:message key="login.regTitle"/></title>
        ...
        <div class="wrap-login100 p-l-55 p-r-55 p-t-60 p-b-54"
            ...
            <form class="login100-form validate-form" method="post"
                ...
                <span class="login100-form-title p-b-49">
						<fmt:message key="login.regTitle"/>
					</span>
                ...
                <div class="text-center txt1 p-t-35">
                    <a>
                        <fmt:message key="login.alreadyHaveAccount"/>
                    </a>
                </div>

                <div class="txt1 text-center p-t-2 p-b-15">
                    <a href="${pageContext.request.contextPath}/jsp/pages/auth/login.jsp" class="txt2">
                        <fmt:message key="login.login"/>
                    </a>
                </div>
            </form>

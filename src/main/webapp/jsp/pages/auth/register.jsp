...
<div class="limiter">
    <div class="login-container"
        ...
        <div class="login-wrap p-l-55 p-r-55 p-t-50 p-b-54"
            ...
            <form id="registrationForm" class="login-form validate-form"
                  action="${pageContext.request.contextPath}/controller"
                  onsubmit="return false;"> <!-- CHANGED onsubmit! -->
                ...
                <div class="form-group input-group m-t-10" data-validate="OPA-PA">
                    ...
                    <input name="password" class="input form-control" placeholder="${firstPassPlaceholder}"
                           type="password">
                </div> <!-- form-group// -->
                <div class="form-group input-group m-t-10">
                    <div class="input-group-prepend">
                    ...
                    <input name="passwordRepeat" class="input form-control" placeholder="${secondPassPlaceholder}"
                           type="password">
                </div> <!-- form-group// -->
                <div class="form-group text-center m-t-30">
                    <button id="submitButton" type="submit" class="btn btn-primary btn-block"><fmt:message
